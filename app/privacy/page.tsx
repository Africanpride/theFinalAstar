...
export default function ContactPage() {
  return (
    <div className='space-y-2 w-full p-4 md:p-16 bg-gray-200 rounded-2xl my-8 text-md'>
      ...
      <ul>
        ...
        <li>
          <p className='whitespace-normal break-words'>
            ...
            "Us" or "Our" in this Agreement) refers to Astar Trade &b Agro
            Processing Co. Ltd, H/No.178/14 Otsew Street, Ako Adjei, Accra.
            Ghana.
          </p>
        </li>
        <li>
        ...
        <li>
          <p className='whitespace-normal break-words'>
            <strong>Website</strong> refers to Astar Trade &b Agro Processing
      ...
      <ul>
        <li>
          <p className='whitespace-normal break-words'>Email address</p>
        </li>
        <li>
          <p className='whitespace-normal break-words'>
        ...
        <li>
          <p className='whitespace-normal break-words'>Phone number</p>
        </li>
        <li>
          <p className='whitespace-normal break-words'>Usage Data</p>
        </li>
      </ul>
      <h4>Usage Data</h4>
      <p className='whitespace-normal break-words'>
      ...
      <ul>
        <li>
          ...
          <p className='whitespace-normal break-words'>Type: Session Cookies</p>
          <p className='whitespace-normal break-words'>Administered by: Us</p>
          <p className='whitespace-normal break-words'>
